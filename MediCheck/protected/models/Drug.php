...
class Drug extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, remarks, type', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, remarks, type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'prescriptions' => array(self::MANY_MANY, 'Prescription', 'patient_doctor_drug(drugid, prescriptionid)'),
		);
	}
